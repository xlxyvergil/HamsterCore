...
public class HeatElementEnchantment extends ElementEnchantment {
    private static final UUID HEAT_MODIFIER_UUID = UUID.fromString("656c6501-0000-0000-0000-000000000000");
    
    public HeatElementEnchantment() {
        super(Rarity.UNCOMMON, ElementType.HEAT, 5, "enchantment_heat", HEAT_MODIFIER_UUID);
    }
