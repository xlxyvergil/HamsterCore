...
public class SentientElementEnchantment extends ElementEnchantment {
    private static final UUID SENTIENT_MODIFIER_UUID = UUID.fromString("656c6512-0000-0000-0000-000000000000");
    
    public SentientElementEnchantment() {
        super(Rarity.VERY_RARE, ElementType.SENTIENT, 5, "enchantment_sentient", SENTIENT_MODIFIER_UUID);
    }
