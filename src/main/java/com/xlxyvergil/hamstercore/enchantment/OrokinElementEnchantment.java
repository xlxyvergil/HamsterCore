...
public class OrokinElementEnchantment extends ElementEnchantment {
    private static final UUID OROKIN_MODIFIER_UUID = UUID.fromString("656c6511-0000-0000-0000-000000000000");
    
    public OrokinElementEnchantment() {
        super(Rarity.VERY_RARE, ElementType.OROKIN, 5, "enchantment_orokin", OROKIN_MODIFIER_UUID);
    }
