...
public class ColdElementEnchantment extends ElementEnchantment {
    private static final UUID COLD_MODIFIER_UUID = UUID.fromString("656c6504-0000-0000-0000-000000000000");
    
    public ColdElementEnchantment() {
        super(Rarity.UNCOMMON, ElementType.COLD, 5, "enchantment_cold", COLD_MODIFIER_UUID);
    }
