...
public class ChemicalElementEnchantment extends ElementEnchantment {
    private static final UUID CHEMICAL_MODIFIER_UUID = UUID.fromString("656c6506-0000-0000-0000-000000000000");
    
    public ChemicalElementEnchantment() {
        super(Rarity.UNCOMMON, ElementType.CHEMICAL, 5, "enchantment_chemical", CHEMICAL_MODIFIER_UUID);
    }
