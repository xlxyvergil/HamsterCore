...
public class InfestedElementEnchantment extends ElementEnchantment {
    private static final UUID INFESTED_MODIFIER_UUID = UUID.fromString("656c650e-0000-0000-0000-000000000000");
    
    public InfestedElementEnchantment() {
        super(Rarity.VERY_RARE, ElementType.INFESTED, 5, "enchantment_infested", INFESTED_MODIFIER_UUID);
    }
