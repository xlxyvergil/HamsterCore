...
public class BlastElementEnchantment extends ElementEnchantment {
    private static final UUID BLAST_MODIFIER_UUID = UUID.fromString("656c6508-0000-0000-0000-000000000000");
    
    public BlastElementEnchantment() {
        super(Rarity.RARE, ElementType.BLAST, 5, "enchantment_blast", BLAST_MODIFIER_UUID);
    }
