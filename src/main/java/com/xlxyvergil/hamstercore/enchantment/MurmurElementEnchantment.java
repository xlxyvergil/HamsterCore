...
public class MurmurElementEnchantment extends ElementEnchantment {
    private static final UUID MURMUR_MODIFIER_UUID = UUID.fromString("656c6513-0000-0000-0000-000000000000");
    
    public MurmurElementEnchantment() {
        super(Rarity.VERY_RARE, ElementType.MURMUR, 5, "enchantment_murmur", MURMUR_MODIFIER_UUID);
    }
