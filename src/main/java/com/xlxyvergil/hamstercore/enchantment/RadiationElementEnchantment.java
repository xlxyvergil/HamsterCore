...
public class RadiationElementEnchantment extends ElementEnchantment {
    private static final UUID RADIATION_MODIFIER_UUID = UUID.fromString("656c6509-0000-0000-0000-000000000000");
    
    public RadiationElementEnchantment() {
        super(Rarity.RARE, ElementType.RADIATION, 5, "enchantment_radiation", RADIATION_MODIFIER_UUID);
    }
