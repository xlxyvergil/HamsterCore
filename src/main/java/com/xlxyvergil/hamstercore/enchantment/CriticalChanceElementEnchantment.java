...
public class CriticalChanceElementEnchantment extends ElementEnchantment {
    private static final UUID CRITICAL_CHANCE_MODIFIER_UUID = UUID.fromString("656c6514-0000-0000-0000-000000000000");
    
    public CriticalChanceElementEnchantment() {
        super(Rarity.RARE, ElementType.CRITICAL_CHANCE, 5, "enchantment_critical_chance", CRITICAL_CHANCE_MODIFIER_UUID);
    }
