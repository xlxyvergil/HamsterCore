...
public class CriticalDamageElementEnchantment extends ElementEnchantment {
    private static final UUID CRITICAL_DAMAGE_MODIFIER_UUID = UUID.fromString("656c6515-0000-0000-0000-000000000000");
    
    public CriticalDamageElementEnchantment() {
        super(Rarity.RARE, ElementType.CRITICAL_DAMAGE, 5, "enchantment_critical_damage", CRITICAL_DAMAGE_MODIFIER_UUID);
    }
