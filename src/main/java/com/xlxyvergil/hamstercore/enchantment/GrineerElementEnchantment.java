...
public class GrineerElementEnchantment extends ElementEnchantment {
    private static final UUID GRINEER_MODIFIER_UUID = UUID.fromString("656c6510-0000-0000-0000-000000000000");
    
    public GrineerElementEnchantment() {
        super(Rarity.VERY_RARE, ElementType.GRINEER, 5, "enchantment_grineer", GRINEER_MODIFIER_UUID);
    }
