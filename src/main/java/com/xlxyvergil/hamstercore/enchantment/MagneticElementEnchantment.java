...
public class MagneticElementEnchantment extends ElementEnchantment {
    private static final UUID MAGNETIC_MODIFIER_UUID = UUID.fromString("656c650b-0000-0000-0000-000000000000");
    
    public MagneticElementEnchantment() {
        super(Rarity.RARE, ElementType.MAGNETIC, 5, "enchantment_magnetic", MAGNETIC_MODIFIER_UUID);
    }
