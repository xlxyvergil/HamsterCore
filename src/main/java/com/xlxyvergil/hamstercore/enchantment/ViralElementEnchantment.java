...
public class ViralElementEnchantment extends ElementEnchantment {
    private static final UUID VIRAL_MODIFIER_UUID = UUID.fromString("656c650c-0000-0000-0000-000000000000");
    
    public ViralElementEnchantment() {
        super(Rarity.RARE, ElementType.VIRAL, 5, "enchantment_viral", VIRAL_MODIFIER_UUID);
    }
