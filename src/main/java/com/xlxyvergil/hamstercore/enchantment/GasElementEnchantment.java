...
public class GasElementEnchantment extends ElementEnchantment {
    private static final UUID GAS_MODIFIER_UUID = UUID.fromString("656c650a-0000-0000-0000-000000000000");
    
    public GasElementEnchantment() {
        super(Rarity.RARE, ElementType.GAS, 5, "enchantment_gas", GAS_MODIFIER_UUID);
    }
