...
public class ElectricityElementEnchantment extends ElementEnchantment {
    private static final UUID ELECTRICITY_MODIFIER_UUID = UUID.fromString("656c6505-0000-0000-0000-000000000000");
    
    public ElectricityElementEnchantment() {
        super(Rarity.UNCOMMON, ElementType.ELECTRICITY, 5, "enchantment_electricity", ELECTRICITY_MODIFIER_UUID);
    }
