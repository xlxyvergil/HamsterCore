...
public class ImpactElementEnchantment extends ElementEnchantment {
    private static final UUID IMPACT_MODIFIER_UUID = UUID.fromString("656c6503-0000-0000-0000-000000000000");
    
    public ImpactElementEnchantment() {
        super(Rarity.COMMON, ElementType.IMPACT, 5, "enchantment_impact", IMPACT_MODIFIER_UUID);
    }
