...
public class ToxinElementEnchantment extends ElementEnchantment {
    private static final UUID TOXIN_MODIFIER_UUID = UUID.fromString("656c6507-0000-0000-0000-000000000000");
    
    public ToxinElementEnchantment() {
        super(Rarity.UNCOMMON, ElementType.TOXIN, 5, "enchantment_toxin", TOXIN_MODIFIER_UUID);
    }
