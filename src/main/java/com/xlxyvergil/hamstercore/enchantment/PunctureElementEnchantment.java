...
public class PunctureElementEnchantment extends ElementEnchantment {
    private static final UUID PUNCTURE_MODIFIER_UUID = UUID.fromString("656c6502-0000-0000-0000-000000000000");
    
    public PunctureElementEnchantment() {
        super(Rarity.COMMON, ElementType.PUNCTURE, 5, "enchantment_puncture", PUNCTURE_MODIFIER_UUID);
    }
