...
| **UNCOMMON** | 50 | 主世界+下界 | 略优于基础，前期提升体验 |
| **RARE** | 20 | 全维度 | 核心追求装备，全程可掉落 |
| **EPIC** | 10 | 下界+末地 | 高级改装件，需要冒险获取 |
| **MYTHIC** | 1 | 仅末地 | 顶级改装件，终局目标 |
...
1. **COMMON/UNCOMMON**: 限制在主世界和下界，避免玩家过早进入末地就能刷到高级改装件
2. **RARE**: 全维度掉落，作为核心过渡装备，任何阶段都能获取
3. **EPIC**: 需要冒险（下界+末地），符合史诗定位
4. **MYTHIC**: 仅末地，成为终局内容和成就象征

#### 掉落概率参考

假设某武器类别每个稀有度有 3 个改装件：

| 维度 | COMMON | UNCOMMON | RARE | EPIC | MYTHIC |
|------|--------|----------|------|------|--------|
| **主世界** | 59% | 29% | 12% | 0% | 0% |
| **下界** | 56% | 28% | 11% | 6% | 0% |
| **末地** | 0% | 0% | 65% | 32% | 3% |
